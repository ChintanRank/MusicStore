...
public String adminLogin(Model model,@RequestParam(value="username",required= false) String UserName,@RequestParam(value="password",required= false) String PassWord
	...
	//String viewSuccess = "redirect:Welcome1.html"; // form OK and processed, show welcome page
	//String redoFormURL = "forward:/adminLoginForm.html"; // redo form (URL back to form req)
